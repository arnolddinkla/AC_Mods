...
# polybar ---------------------------------
sed -i -e 's/STYLE=.*/STYLE="Archcraft_Arc"/g' $polybar_path/launch.sh
sed -i -e 's/font-0 = .*/font-0 = "Sans:size=10;3"/g' $polybar_path/Archcraft_Arc/config.ini

# relaunch polybar
$polybar_path/launch.sh

# rofi ---------------------------------
sed -i -e 's/STYLE=.*/STYLE="Archcraft_Arc"/g' "$rofi_path/bin/mpd" "$rofi_path/bin/network" "$rofi_path/bin/screenshot"
sed -i -e 's/DIR=.*/DIR="Archcraft_Arc"/g' "$rofi_path/bin/launcher" "$rofi_path/bin/powermenu"
sed -i -e 's/STYLE=.*/STYLE="launcher"/g' "$rofi_path/bin/launcher"
sed -i -e 's/STYLE=.*/STYLE="powermenu"/g' "$rofi_path/bin/powermenu"
sed -i -e 's/font:.*/font:				 	"Sans 10";/g' "$rofi_path/Archcraft_Arc/font.rasi"
...
# Network Manager ---------------------------------
sed -i -e 's#dmenu_command = .*#dmenu_command = rofi -dmenu -theme Archcraft_Arc/networkmenu.rasi#g' "$HOME"/.config/networkmanager-dmenu/config.ini
